...
# realice un ping a www.google.com usando el método executefree
# de ping y re-envie a execute de la clase ping en cualquier otro caso.
...
class RealPing(Ping):
    ...
    def ejecutefree(self, ip):
        try:
            ...
            print("No se pudo establecer conexion:", e)
            return False
    ...
    def ejecute(self, ip):
        ...
        if self.check_ip(ip):
            if self._real_ping.ejecutefree("172.217.167.196"):
                print("Conexion con www.google.com")
